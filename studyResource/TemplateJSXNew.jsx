...
class TemplateJSXNew extends React.Component {
  /*生命周期功能替换一览*/
  ...
  constructor(props, context) {
    ...
    console.log('TemplateJSXNew constructor ? props', props);
    // //新的ref绑定方法
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    console.log('TemplateJSXNew getDerivedStateFromProps ? nextProps', nextProps);
    console.log('TemplateJSXNew getDerivedStateFromProps ? prevState', prevState);
    return null;
    // return myLifeCircle.getDerivedStateFromProps({
    //     componentName: 'TemplateJSXNew',
    //     nextProps: nextProps,
    //     prevState: prevState,
    //     customReturn: null
    // });
  ...
  UNSAFE_componentWillMount() {
    console.log('TemplateJSXNew UNSAFE_componentWillMount ? ?', new Date());
  }
  ...
  componentDidMount() {
    // 监听事件和请求数据
    console.log('TemplateJSXNew componentDidMount ? ?', new Date());
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    console.log('TemplateJSXNew UNSAFE_componentWillReceiveProps ? ?', new Date());
    // this.setState({
  ...
  shouldComponentUpdate(nextProps, nextState, nextContext) {
    console.log('TemplateJSXNew shouldComponentUpdate ? nextProps', nextProps);
    console.log('TemplateJSXNew shouldComponentUpdate ? nextState', nextState);
    console.log('TemplateJSXNew shouldComponentUpdate ? nextContext', nextContext);
    return true;
  }
  ...
  UNSAFE_componentWillUpdate(nextProps, nextState) {
    console.log('TemplateJSXNew UNSAFE_componentWillUpdate ? nextProps', nextProps);
    console.log('TemplateJSXNew UNSAFE_componentWillUpdate ? nextState', nextState);
  }
  ...
  getSnapshotBeforeUpdate(prevProps, prevState) {
    console.log('TemplateJSXNew getSnapshotBeforeUpdate ? prevProps', prevProps);
    console.log('TemplateJSXNew getSnapshotBeforeUpdate ? prevState', prevState);
    return null;
  }
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    console.log('TemplateJSXNew componentDidUpdate ? prevProps', prevProps);
    console.log('TemplateJSXNew componentDidUpdate ? prevState', prevState);
    console.log('TemplateJSXNew componentDidUpdate ? snapshot', snapshot);
  }
  ...
  componentWillUnmount() {
    console.log('TemplateJSXNew componentWillUnmount ? ?', new Date());
  }
  ...
  componentDidCatch(errorString, errorInfo) {
    console.warn('TemplateJSXNew componentDidCatch ? errorString', errorString);
    console.warn('TemplateJSXNew componentDidCatch ? errorInfo', errorInfo);
  }
