module.exports = [
  ...
  },
  {
    key: 'recycle',
    name: 'recycle',
    path: 'dataList/recycle/Index.jsx',
    title: '回收站',
    keywords: 'futureD, 数据管理, 数据分析',
  ...
  },
  {
    key: 'admin',
    name: 'admin',
    path: 'admin/Index.jsx',
    title: '管理员页面',
    keywords: 'futureD, 数据管理, 数据分析',
    description: 'futureD数据管理与数据分析的管理员页面'
  },
  {
    key: 'user',
    name: 'user',
    ...
    title: '个人账号',
    keywords: 'futureD, 数据管理, 数据分析',
    description: 'futureD数据管理与数据分析的个人账号'
  },
  {
    key: 'SP2',
    name: 'SP2',
    path: 'RFS2P/SP2/Index.jsx',
    title: 'SP2页面',
    keywords: 'futureD, 数据管理, 数据分析',
    description: 'futureD数据管理与数据分析的SP2页面'
  }
];
