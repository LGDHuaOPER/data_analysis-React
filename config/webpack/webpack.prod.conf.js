    ...
    rules: [
      ...
      },
      {
        ...
        loader:
          ...
          webpackFile.resourcePrefixInCss +
          '&outputPath=' +
      ...
      },
      {
        ...
        loader:
          'url-loader?limit=8192&name=[name].[hash:8].[ext]&publicPath=' +
          webpackFile.resourcePrefixInHtml +
          '&outputPath=' +
          webpackFile.resource +
          '/'
      },
...
let copyArr = [];
copyObj.map((data) => {
  copyArr.push(new CopyWebpackPlugin([{ from: data.from, to: data.to, ignore: ['.*'] }]));
});
