    ...
    if(!_.isNil(customReturn)){
        ...
        if(_.eq(baseOptions.version, "V16.3")){
            ...
            if(!_.isEqual(nextProps, prevState[baseOptions.getDerivedStateFromProps.componentLastProps])){
                ...
                console.log(componentName+" getDerivedStateFromProps nextProps!=prevState."+baseOptions.getDerivedStateFromProps.componentLastProps+" "+baseOptions.getDerivedStateFromProps.componentLastProps, componentLastProps);
            }
            let stateValueInPropsChange = {};
            if(_.isEqual(_.sortBy(nextProps[baseOptions.getDerivedStateFromProps.stateKeyInProps]), _.sortBy(prevState[baseOptions.getDerivedStateFromProps.stateKeyInProps]))){
        ...
        if(_.eq(baseOptions.version, "V16.3")){
            ...
            if(_.isNil(nextContext) || _.isEmpty(nextContext)){
                ...
                if(_.isEqual(nextProps, prevState[baseOptions.shouldComponentUpdate.componentLastProps])){
                    console.log(componentName+" shouldComponentUpdate nextProps==prevState."+baseOptions.shouldComponentUpdate.componentLastProps+" ?", new Date());
                    return false;
                }else{
                    ...
                    if(_.eq(propsShould, false)){
                        ...
                        if(!_.isNil(propsShouldReturn)){
                            ...
                            if(_.isEqual(_.sortBy(nextProps[baseOptions.shouldComponentUpdate.stateKeyInProps]), _.sortBy(prevState[baseOptions.shouldComponentUpdate.stateKeyInProps]))){
                                ...
                                if(_.isEqual(prevStatePick, nextStatePick)){
                                    console.log(componentName+" shouldComponentUpdate prevStatePick==nextStatePick prevStatePick", prevStatePick);
                                    return false;
                                }
                            }
                            return true;
